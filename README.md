...
Проект продуктовой аналитики на данных соревнования [Expedia Hotel Recommendations](https://www.kaggle.com/competitions/expedia-hotel-recommendations/data). Исходный датасет содержит обезличенные события поиска, просмотра и бронирования отелей за 2013-2014 годы.
